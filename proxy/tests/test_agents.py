...
class AgentRegistryTests(unittest.TestCase):
    ...
    def test_legacy_aliases_are_rejected(self) -> None:
        self.assertIsNone(normalize_agent_id("ace"))
        self.assertIsNone(normalize_agent_id("owl"))
        self.assertIsNone(normalize_agent_id("dolphin"))
